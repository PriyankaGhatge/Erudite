							...
							<div
								...
								<div class="row">
									<div class="col-xs-6 col-sm-6 col-md-6">
										<address>
											...
											${order.cart.usercustomer.shippingAddress.addressline1} <br />
											 ${order.cart.usercustomer.shippingAddress.addressline2}
											<br /> ${order.cart.usercustomer.shippingAddress.city},
											${order.cart.usercustomer.shippingAddress.state} <br />
											${order.cart.usercustomer.shippingAddress.country},
								...
								<div class="row">
									<div class="col-xs-6 col-sm-6 col-md-6">
										<address>
											...
											${order.cart.usercustomer.billingAddress.addressline1} <br />
											Landmark: ${order.cart.usercustomer.billingAddress.addressline2}
											<br /> ${order.cart.usercustomer.billingAddress.city},
											${order.cart.usercustomer.billingAddress.state} <br />
											${order.cart.usercustomer.billingAddress.country},
								...
								<div class="table-responsive">
									<table class="tg">
										...
										<tbody>
											<c:forEach var="cartItem" items="${order.cart.cartitems}">    <!--cartItems  -->
												<tr>
