				...
				<div class="form-w3agileabc form1">
					...
					<form:form commandName="order" class="form-horizontal">
						...
						<div class="form-group">
							...
							<div class="key">
								<i class="glyphicon glyphicon-user" aria-hidden="true"></i>
								<form:input path="cart.usercustomer.email" />
								<div class="clearfix"></div>
							</div>
							...
							<div class="key">
								<i class="glyphicon glyphicon-user" aria-hidden="true"></i>
								<form:input path="cart.usercustomer.contact" />
								<div class="clearfix"></div>
							</div>
							...
							<div class="key">
								<i class="glyphicon glyphicon-user" aria-hidden="true"></i>
								<form:input path="cart.usercustomer.billingAddress.addressline1" />
								<div class="clearfix"></div>
							</div>
							...
							<div class="key">
								<i class="glyphicon glyphicon-user" aria-hidden="true"></i>
								<form:input path="cart.usercustomer.billingAddress.addressline2" />
								<div class="clearfix"></div>
							</div>
							...
							<div class="key">
								<i class="glyphicon glyphicon-user" aria-hidden="true"></i>
								<form:input path="cart.usercustomer.billingAddress.city" />
								<div class="clearfix"></div>
							</div>
							...
							<div class="key">
								<i class="glyphicon glyphicon-user" aria-hidden="true"></i>
								<form:input path="cart.usercustomer.billingAddress.state" />
								<div class="clearfix"></div>
							</div>
							...
							<div class="key">
								<i class="glyphicon glyphicon-user" aria-hidden="true"></i>
								<form:input path="cart.usercustomer.billingAddress.country" />
								<div class="clearfix"></div>
							</div>
